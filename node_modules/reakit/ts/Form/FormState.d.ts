...
export declare type unstable_FormState<V> = {
    /**
...
export declare type unstable_FormActions<V> = {
    /**
...
export declare type unstable_FormInitialState<V> = Partial<Pick<unstable_FormState<V>, "baseId" | "values">> & {
    /**
...
export declare namespace unstable_useFormState {
    var __keys: ("reset" | "update" | "submit" | "blur" | "push" | "values" | "baseId" | "touched" | "messages" | "errors" | "validating" | "valid" | "submitting" | "submitSucceed" | "submitFailed" | "remove" | "validate")[];
}
export {};

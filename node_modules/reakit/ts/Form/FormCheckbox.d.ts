...
import { PropsWithAs, ArrayValue, Omit } from "reakit-utils/types";
...
export declare const unstable_useFormCheckbox: <V, P extends DeepPath<V, P>>(options: unstable_FormCheckboxOptions<V, P>, htmlProps?: CheckboxHTMLProps | undefined) => CheckboxHTMLProps;

...
import { RoverStateReturn } from "../Rover/RoverState";
...
export declare const FormRadioGroupContext: React.Context<RoverStateReturn | null>;
export declare const unstable_useFormRadioGroup: <V, P extends DeepPath<V, P>>(options: unstable_FormRadioGroupOptions<V, P>, htmlProps?: unstable_FormGroupHTMLProps | undefined) => unstable_FormGroupHTMLProps;

...
import { useRef, useLayoutEffect, useEffect, createContext, useContext, useState, useCallback, useMemo, createElement } from 'react';
...
function useEventListenerOutside(targetRef, disclosuresRef, nestedDialogs, event, listener, shouldListen) {
  ...
  }, [targetRef, disclosuresRef, nestedDialogs, event, shouldListen, listenerRef]);
}

function useHideOnClickOutside(dialogRef, disclosuresRef, nestedDialogs, options) {
  useEventListenerOutside(dialogRef, disclosuresRef, nestedDialogs, "click", options.hide, options.visible && options.hideOnClickOutside);
